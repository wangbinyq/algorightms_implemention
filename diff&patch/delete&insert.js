...
function test(str1, str2) {
    ...
    console.assert(str === str2, str, str2, patches)
}
...
(function main() {
    const arr_str1 = [
        ...
        '',
        'XMJYAUZ',
        'sdfdgerfefrasdfasfwefafdasfhtjhshfoaihfdjljhsoidfyoieufoiufkjdhfoaifpueriuqpfq;efjalfhlaeufhalefuhqleuhrajsdhflermnhcneyrhuaychhcf'
    ], arr_str2 = [
        'MZJAWXU',
        'MZJAWXU',
        '',
        'ajsdlkfjoievnuieac;ejfeihvuehroa;fheurhahshfjhafjkhashdfueghwuegfaksdhflhevalghvkaecuhel veurheuhfaoeshfksjhfehfua'
    ]
